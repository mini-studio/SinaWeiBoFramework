...
#define KError_NotAuthorized 400
#define KError_AuthorizeExpired 401

#define KError_AlreadyLoggedIn 402
...
- (void)engine:(WBEngine *)engine authViewAppear:(UIView*)view;

- (void)engineRequestStart:(WBEngine *)engine;
- (void)engineRequestEnd:(WBEngine *)engine;
...
@interface WBEngine : NSObject <WBAuthorizeDelegate, WBRequestDelegate>
{
    ...
    void (^weiBoRequestBlock)(NSError *error,id data);
