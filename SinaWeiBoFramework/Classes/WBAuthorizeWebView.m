...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        [[containerView layer] setBorderColor:[UIColor clearColor].CGColor];
...
////        [panelView setFrame:CGRectMake(0, 30, 320, 440)];
////        [containerView setFrame:CGRectMake(0, 4, 320, 432)];
////        [webView setFrame:CGRectMake(4, 0, 312, 432)];
//    }
//    
...
{
    [delegate authorizeWebViewRequestEnd:nil];
}

- (void)webView:(UIWebView *)aWebView didFailLoadWithError:(NSError *)error
{
    [delegate authorizeWebViewRequestEnd:[error localizedDescription]];
}

- (BOOL)webView:(UIWebView *)aWebView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    [delegate authorizeWebViewRequestStart];
